...
#if defined(NDEBUG)
# error "vRolexCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "vRolexCoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("vrolexcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // vRolexCoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet & regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // vRolexCoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
